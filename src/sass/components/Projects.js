                            ...
                            <div className="card__side card__side--back card__side--back-1">
                                <div className="card__cta">
                                        <div className="card__box">
                                            <a href="https://github.com/jsoto007/learn-link" target="_blank" className="btn btn--white a1">
                                                <img src={ git } alt="Github" className="card__picture card__picture--back" />
                                            </a>
                                            <br/>
                                            <a href="#popup1" className="btn btn--white a2">
                    ...
                    <div className="col-1-of-3">
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-2">
                                <div className="card__cta">
                                        <div className="card__box">
                                            <a href="https://github.com/ThisBackpackersLife/p5-project" target="_blank" className="btn btn--white">
                                                <img src={ git } alt="Github" className="card__picture card__picture--back" />
                                            </a>
                                            <br/>
                    ...
                    <div className="col-1-of-3">
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-3">
                                <div className="card__cta">
                                        <div className="card__box">
                                            <a href="https://github.com/ThisBackpackersLife/group6-phase4-project" target="_blank" className="btn btn--white">
                                                <img src={ git } alt="Github" className="card__picture card__picture--back" />
                                            </a>
                                            <br/>
